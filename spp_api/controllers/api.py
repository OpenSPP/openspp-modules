...
#             api_namespace = kwargs.get("namespace")
#             api_version = kwargs.get("version")
#             api_method = kwargs.get("method_name")
# 
#             if not api_namespace or not api_version:
#                 raise werkzeug.exceptions.HTTPException(
#                     response=pinguin.error_response(404,
#                                                     "Not Found",
...
# 
#             domain_path = [
#                 ("namespace.name", "=", api_namespace),
#                 ("namespace.version", "=", api_version),
#                 ("method", "=", http_method)
#             ]
# 
