            ...
            for message in messages:
                ...
                for number in numbers:
                    ...
                    try:
                        ...
                        if e.code == 21211:
                            state = "invalid_to_number"
                        elif e.code == 21212:
                            state = "invalid_from_number"
                        elif e.code == 21214:
                            state = "cannot_be_reached"
                        elif e.code == 63038:
                            state = "reached_rate_limit"
                        elif e.code == 21659:
                            state = "invalid_from_number_mismatch"
                        elif e.code == 21267:
                            state = "invalid_from_number_alphanumeric"
                        else:
                            state = "error"
