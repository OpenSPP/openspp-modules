...
class FarmDetails(models.Model):
    ...
    rearing_livestock_subsistence = fields.Boolean(
        string="Rearing livestock for subsistence?"
    )
    ...
    # Livestock
    livestock_fertilizer_for_fodder = fields.Boolean(
        string="Do you utilize fertilizer for fodder and pasture?"
    )
    livestock_certified_pasture = fields.Boolean(
        string="Do you use certified pasture & fodder seeds?"
    )
    ...
    livestock_animal_health_services_routine_vaccination = fields.Boolean(
        string="Routine vaccination"
    )
    livestock_animal_health_services_disease_control = fields.Boolean(
        string="Disease control / curative measures"
    )
    ...
    aquaculture_utilize_fertilizer = fields.Boolean(
        string="Do you utilize fertilizer in the ponds?"
    )
    ...
    farm_technology_structure_spray_race = fields.Boolean(
        default=False, string="Spray Race"
    )
    farm_technology_structure_animal_dip = fields.Boolean(
        default=False, string="Animal Dip"
    )
    farm_technology_structure_loading_ramp = fields.Boolean(
        default=False, string="Loading Ramp"
    )
    farm_technology_structure_zero_grazing_unit = fields.Boolean(
        default=False, string="Zero Grazing Unit"
    )
    farm_technology_structure_hay_store = fields.Boolean(
        default=False, string="Hay Store"
    )
    farm_technology_structure_feed_store = fields.Boolean(
        default=False, string="Feed Store"
    )
    farm_technology_structure_sick_bay = fields.Boolean(
        default=False, string="Sick Bay"
    )
    farm_technology_structure_cattle_boma = fields.Boolean(
        default=False, string="Cattle Boma"
    )
    farm_technology_structure_milking_parlor = fields.Boolean(
        default=False, string="Milking parlor"
    )
    farm_technology_structure_animal_crush = fields.Boolean(
        default=False, string="Animal crush"
    )
    farm_technology_structure_traditional_granary = fields.Boolean(
        default=False, string="Traditional Granary"
    )
    farm_technology_structure_modern_granary = fields.Boolean(
        default=False, string="Modern Granary"
    )
    farm_technology_structure_general_store = fields.Boolean(
        default=False, string="General Store"
    )
    farm_technology_structure_hay_bailers = fields.Boolean(
        default=False, string="Hay Bailers"
    )
    farm_technology_structure_green_house = fields.Boolean(
        default=False, string="Green house"
    )
    farm_technology_structure_bee_house = fields.Boolean(
        default=False, string="Bee House"
    )
    farm_technology_structure_hatchery = fields.Boolean(
        default=False, string="Hatchery"
    )
    farm_technology_structure_apriary = fields.Boolean(default=False, string="Apriary")

    # Farm land and water management
    land_water_management_crop_rotation = fields.Boolean(
        default=False, string="Crop Rotation"
    )
    land_water_management_green_cover_crop = fields.Boolean(
        default=False, string="Green cover crop"
    )
    land_water_management_contour_ploughing = fields.Boolean(
        default=False, string="Contour ploughing/Ridging"
    )
    land_water_management_deep_ripping = fields.Boolean(
        default=False, string="Deep ripping"
    )
    land_water_management_grass_strips = fields.Boolean(
        default=False, string="Grass strips"
    )
    land_water_management_trash_line = fields.Boolean(
        default=False, string="Trash line"
    )
    land_water_management_cambered_beds = fields.Boolean(
        default=False, string="Cambered beds"
    )
    land_water_management_biogas_production = fields.Boolean(
        default=False, string="Biogas production"
    )
    land_water_management_mulching = fields.Boolean(default=False, string="Mulching")
    land_water_management_minimum_tillage = fields.Boolean(
        default=False, string="Minimum Tillage"
    )
    land_water_management_manuring_composting = fields.Boolean(
        default=False, string="Manuring/Composting"
    )
    land_water_management_organic_farming = fields.Boolean(
        default=False, string="Organic farming"
    )
    land_water_management_terracing = fields.Boolean(default=False, string="Terracing")
    land_water_management_water_harvesting = fields.Boolean(
        default=False, string="Water harvesting"
    )
    land_water_management_zai_pits = fields.Boolean(default=False, string="Zai pits")
    land_water_management_cut_off_drains = fields.Boolean(
        default=False, string="Cut-off drains"
    )
    land_water_management_conservation_agriculture = fields.Boolean(
        default=False, string="Conservation agriculture"
    )
    ...
    land_water_management_use_lime = fields.Boolean(
        default=False, string="Do you use lime on your soil?"
    )
    land_water_management_soil_testing = fields.Boolean(
        default=False, string="Have you done soil testing in the last 3 years?"
    )
    land_water_management_undertake_irrigation = fields.Boolean(
        default=False, string="Do you undertake irrigation?"
    )
    ...
    land_water_management_total_irrigated_area = fields.Float(
        string="Total irrigated area"
    )
...
 National Govt.  County Government  NGO
 ...
 """
    ...
    financial_services_vulnerable_marginalized_group = fields.Boolean(
        string="Vulnerable/ Marginalized Group"
    )
    financial_services_faith_based_organization = fields.Boolean(
        string="Faith Based Organization"
    )
    financial_services_community_based_organization = fields.Boolean(
        string="Community Based Organization"
    )
    ...
    financial_services_table_banking_group = fields.Boolean(
        string="Table Banking Group"
    )
    financial_services_common_interest_group = fields.Boolean(
        string="Common Interest Group"
    )

    financial_services_mobile_money_saving_loans = fields.Boolean(
        string="Mobile Money saving & loans"
    )
    financial_services_farmer_organization = fields.Boolean(
        string="Farmer Organization"
    )
    financial_services_other_money_lenders = fields.Boolean(
        string="Other money lenders"
    )
    financial_services_self_salary_or_savings = fields.Boolean(
        string="Self (Salary or Savings)"
    )
    ...
    financial_services_savings_credit_groups = fields.Boolean(
        string="Savings & Credit groups"
    )
    financial_services_cooperatives = fields.Boolean(string="Cooperatives")
    financial_services_micro_finance_institutions = fields.Boolean(
        string="Micro-finance institutions"
    )
    financial_services_non_governmental_donors = fields.Boolean(
        string="Non-governmental donors"
    )

    financial_services_crop_insurance = fields.Boolean(
        string="Do you insure your crops?"
    )
    financial_services_livestock_insurance = fields.Boolean(
        string="Do you insure your livestock?"
    )
    financial_services_fish_insurance = fields.Boolean(
        string="Do you insure your fish?"
    )
