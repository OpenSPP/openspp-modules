...
class TestChangeRequests(Common):
    ...
    def test_01_create_change_request(self):
        self.assertEqual(
    ...
    def test_02_unlink_raise_error_cr(self):
    ...
    def test_04_compute_applicant_id_domain_cr(self):
        self.assertEqual(
    ...
    def test_05_assign_to_user_cr(self):
    ...
    def test_06_onchange_scan_qr_code_details_cr(self):
    ...
    def test_07_open_request_detail_cr(self, phone_parse):
    ...
    def test_08_cancel_error_cr(self):
    ...
    def test_10_check_user_error_cr(self):
    ...
    def test_11_check_user_cr(self):
