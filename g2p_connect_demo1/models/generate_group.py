...
class OpenG2PGenerateData(models.Model):
    ...
    def _generate_individual_data(
        ...
        return {
            ...
            "is_group": False,
            "registration_date": registration_date,
            "z_cst_ind_cyclone_aug_2022_injured": injured,
            "z_cst_ind_disability_level": disability_level,
            "z_cst_ind_receive_government_benefits": gov_benefits,
            "z_cst_ind_cyclone_aug_2022_lost_livestock": lost_livestock,
            "z_cst_ind_cyclone_aug_2022_lost_primary_source_income": lost_primary_source_income,
        }
