...
class ProgramSpec(models.Model):
    ...
    event_type_count = fields.Integer(
        string="Event Type Count",
            ...
            try:
                ...
                return {
                    'warning': {
                        ...
                        'message': _("Could not read the uploaded file. Please ensure it's a valid text file.\n\nError: %s", str(e))
                    }
                }
    ...
    def action_deploy(self):
        ...
        try:
            ...
            return {
                ...
                "params": {
                    "title": _("Success"),
                    "message": _("Deployed %d event types (%d new, %d updated).", 
