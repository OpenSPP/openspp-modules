...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:8ae207b291ad9bdb2d6c86272a23417f3de08db66d9aab59c904d9d0991962af
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OpenSPP%2Fopenspp--modules-lightgray.png?logo=github
    :target: https://github.com/OpenSPP/openspp-modules/tree/17.0/spp_change_request_create_group
...
The
`spp_change_request_create_group <spp_change_request_create_group>`__
module extends the OpenSPP Change Request system to specifically handle
requests for adding new group within the registry. It leverages the
...
process of adding group while maintaining data integrity and
consistency.
...
-  **Specialized Change Request Type**: Introduce a dedicated change
   request type for adding groups, distinct from other types of
...
-  **Custom Change Request Model**: Introduces the
   ``spp.change.request.create.group`` model, inheriting from the base
...
-  **Tailored Forms**: Provides specialized views for creating,
   displaying, and validating ``Create Group`` change requests,
   including a dedicated form
   (``view_change_request_create_group_form``) with relevant fields and
   a validation-focused form
   (``view_change_request_create_group_validation_form``).
-  **Automated Individual and Membership Creation**: Upon validation and
   ...
   -  A new individual registrant record (``res.partner``) for the
      Individual, populating it with the submitted data.
   -  A corresponding group membership record
      (``g2p.group.membership``), linking the newly created Individual
...
The
`spp_change_request_create_group <spp_change_request_create_group>`__
module provides a robust and specialized workflow for adding new group
within the OpenSPP registry. By seamlessly integrating with core change
management and registry modules, it ensures data accuracy, consistency,
and a streamlined user experience for managing group additions.
...
`feedback <https://github.com/OpenSPP/openspp-modules/issues/new?body=module:%20spp_change_request_create_group%0Aversion:%2017.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OpenSPP/openspp-modules <https://github.com/OpenSPP/openspp-modules/tree/17.0/spp_change_request_create_group>`_ project on GitHub.
