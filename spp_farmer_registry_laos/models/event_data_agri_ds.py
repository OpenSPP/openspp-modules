...
class OpenSPPEventDataAgriculturalDS(models.Model):
    ...
    _description = "X. Agricultural Production, Sales, Cost and Technologies During Cold DS (Crops Produced)"
...
class OpenSPPEventDataAgriculturalDSProduced(models.Model):
    ...
    _description = "X. Agricultural Production During Cold DS Lines (Crops Produced)"
...
class OpenSPPEventDataAgriculturalDSCost(models.Model):
    ...
    _description = "X. Agricultural Cost During Cold DS Lines (Crops Produced)"
...
class OpenSPPEventDataAgriculturalDSTech(models.Model):
    ...
    _description = "X. Agricultural Technologies During Cold DS Lines (Crops Produced)"
