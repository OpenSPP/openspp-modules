...
class SPPCreateEventAgriculturalDSHotWizard(models.TransientModel):
    _name = "spp.create.event.agri.ds.hot.wizard"
    ...
    agri_cost_ids = fields.One2many(
        "spp.create.event.agri.ds.hot.cost.wizard",
        "agri_ds_hot_id",
        string="Agricultural Cost During Cold DS",
    )
    agri_tech_ids = fields.One2many(
        "spp.create.event.agri.ds.hot.tech.wizard",
        "agri_ds_hot_id",
...
class SPPCreateEventAgriculturalDSHotProduceWizard(models.TransientModel):
    _name = "spp.create.event.agri.ds.hot.prod.wizard"
    _description = "XI. Agricultural Production During the Hot DS"

    agri_ds_hot_id = fields.Many2one(
        "spp.create.event.agri.ds.hot.wizard",
...
class SPPCreateEventAgriculturalDSHotCostWizard(models.TransientModel):
    _name = "spp.create.event.agri.ds.hot.cost.wizard"
...
class SPPCreateEventAgriculturalDSHotTechWizard(models.TransientModel):
    _name = "spp.create.event.agri.ds.hot.tech.wizard"
