...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:86dd4016d2adbcaf62d6160e5d44d8760bb099e92e924c8faf01c66218396a9c
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
.. |badge3| image:: https://img.shields.io/badge/github-OpenSPP%2Fopenspp--modules-lightgray.png?logo=github
    :target: https://github.com/OpenSPP/openspp-modules/tree/17.0/spp_change_request_create_farm
...
The `spp_change_request_create_farm <spp_change_request_create_farm>`__
...
-  **Custom Change Request Model**: Introduces the
   ``spp.change.request.create.farm`` model, inheriting from the base
...
-  **Tailored Forms**: Provides specialized views for creating,
   displaying, and validating ``Create Farm`` change requests, including
   a dedicated form (``view_change_request_create_farm_form``) with
...
The `spp_change_request_create_farm <spp_change_request_create_farm>`__
module provides a robust and specialized workflow for adding new Farm
...
and a streamlined user experience for managing farmer additions.
...
`feedback <https://github.com/OpenSPP/openspp-modules/issues/new?body=module:%20spp_change_request_create_farm%0Aversion:%2017.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `OpenSPP/openspp-modules <https://github.com/OpenSPP/openspp-modules/tree/17.0/spp_change_request_create_farm>`_ project on GitHub.
