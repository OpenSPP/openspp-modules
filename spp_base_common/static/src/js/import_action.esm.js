...
odoo.loader.bus.addEventListener("module-started", ({detail:started}) => {
    if (started === "@base_import/import_action") {
        const {ImportAction} = odoo.loader.modules.get("@base_import/import_action");
